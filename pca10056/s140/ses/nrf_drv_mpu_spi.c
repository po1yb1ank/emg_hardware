 ...
 */
#define MPU_SPI_MISO_PIN    19 // MPU SDO. 'AD0' on MPU breakout board silk screen
#define MPU_SPI_MOSI_PIN    20 // MPU SDI. 'SDA' on MPU breakout board silk screen
#define MPU_SPI_SCL_PIN     18 // MPU SCLK. 'SCL' on MPU breakout board silk screen
#define MPU_SPI_CS_PIN      17 // MPU nCS. 'NCS' on MPU breakout board silk screen
