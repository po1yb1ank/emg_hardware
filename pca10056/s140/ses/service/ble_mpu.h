...
#define BLE_UUID_BASE_UUID              {0x00, 0xC7, 0xC6, 0x4E, 0xE3, 0x6C, 0x51, 0xA7, 0x33, 0x4B, 0xE8, 0xED, 0x5A, 0x0E, 0xB8, 0x03}
#define BLE_UUID_MPU_SERVICE_UUID                0x0E5C // Just a random, but recognizable value

#define BLE_UUID_ACCEL_CHARACTERISTC_UUID          0x0E5D // Just a random, but recognizable value
